...
```{r, warning=FALSE, PeerJrecperfield, fig.width=15, fig.height=10, fig.cap = "Proportion of 'minor revisions' or 'major revisions' recommendations by the handling editor at PeerJ conditioned on whether reviews were signed or unsigned."}
